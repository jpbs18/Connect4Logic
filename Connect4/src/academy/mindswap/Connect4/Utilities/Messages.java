...
public class Messages {
    ...
    public final static String YOUR_TURN = "It's your turn, please insert move from 0 to 6";
    public final static String OPPONENT_TURN = "It's your opponent's turn!\n";
    public final static String WANT_TO_PLAY = "Want to play another game?(yes/no)";
